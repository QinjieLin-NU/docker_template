...
#include conda to bashrc
sudo grep -F ". /opt/conda/etc/profile.d/conda.sh" ~/.bashrc || sudo echo ". /opt/conda/etc/profile.d/conda.sh" >> ~/.bashrc
sudo grep -F "conda activate base" ~/.bashrc || sudo echo "conda activate base" >> ~/.bashrc
source $HOME/.bashrc
